import { Flex, Group, Paper, SimpleGrid, Text, useMantineColorScheme } from "@mantine/core";
...
const TrainerCardDual = ({ dashboard }: { dashboard: DashboardStats }) => {
  ...
  return (
    <Paper withBorder p="md" radius={"md"} style={{ color: colorScheme == "dark" ? "white" : "black" }}>
      <Group wrap="nowrap">
...
const Trainers = ({
  ...
  return (
    <div>
      ...
      <SimpleGrid spacing={10} cols={{ base: 1, sm: 2, md: 3, 1280: 3, 1780: 4 }}>
