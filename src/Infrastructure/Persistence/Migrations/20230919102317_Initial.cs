...
namespace Infrastructure.Persistence.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "id", "address", "bio", "created_by", "created_on", "department_id", "email", "first_name", "hash_password", "image_url", "last_name", "member_id", "middle_name", "mobile_number", "password_change_token", "password_reset_token", "password_reset_token_expiry", "profession", "public_urls", "role", "status", "updated_by", "updated_on" },
                values: new object[] { "30fcd978-f256-4733-840f-759181bc5e63", "ADDRESS", null, "30fcd978-f256-4733-840f-759181bc5e63", new DateTime(2022, 11, 4, 10, 35, 19, 307, DateTimeKind.Utc).AddTicks(3004), null, "vuriloapp@gmail.com", "ABC", "+gURQgHBT1zJz5AljZhAMyaNRFQBVorq5HIlEmhf+ZQ=:BBLvXedGXzdz0ZlypoKQxQ==", null, "XYZ", null, null, "1234567890", null, null, null, null, null, 1, 1, "30fcd978-f256-4733-840f-759181bc5e63", new DateTime(2022, 11, 4, 10, 35, 19, 307, DateTimeKind.Utc).AddTicks(3004) });

            migrationBuilder.InsertData(
                table: "GeneralSettings",
                columns: new[] { "id", "company_address", "company_contact_number", "company_name", "created_by", "created_on", "custom_configuration", "email_signature", "logo_url", "updated_by", "updated_on" },
                values: new object[] { "2d7867fc-b7e7-461d-9257-d0990b5ac991", "company address", "company contact number", "company name", "30fcd978-f256-4733-840f-759181bc5e63", new DateTime(2022, 11, 4, 10, 35, 19, 307, DateTimeKind.Utc).AddTicks(3004), null, "company default email signature", "image path", "30fcd978-f256-4733-840f-759181bc5e63", new DateTime(2022, 11, 4, 10, 35, 19, 307, DateTimeKind.Utc).AddTicks(3004) });
            ...
            migrationBuilder.InsertData(
                table: "SMTPSettings",
                columns: new[] { "id", "created_by", "created_on", "mail_port", "mail_server", "password", "reply_to", "sender_email", "sender_name", "updated_by", "updated_on", "UseSSL", "user_name" },
