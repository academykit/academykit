...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221117060930_assignments tables")]
    partial class assignmentstables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lingtren.Domain.Entities.AssignmentMCQSubmission", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                    ...
                    b.Property<string>("AssignmentQuestionId")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("VARCHAR(50)")
                    ...
                    b.ToTable("AssignmentMCQSubmissions");
                });

            modelBuilder.Entity("Lingtren.Domain.Entities.AssignmentQuestion", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("Lingtren.Domain.Entities.AssignmentMCQSubmission", b =>
                {
                    b.HasOne("Lingtren.Domain.Entities.Assignment", "Assignment")
                        .WithMany("AssignmentMCQSubmissions")
                        .HasForeignKey("AssignmentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Lingtren.Domain.Entities.AssignmentQuestion", "AssignmentQuestion")
                        .WithMany("AssignmentMCQSubmissions")
            ...
            modelBuilder.Entity("Lingtren.Domain.Entities.Assignment", b =>
                {
                    ...
                    b.Navigation("AssignmentMCQSubmissions");
