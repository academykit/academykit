        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<string>(type: "VARCHAR(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    api_key = table.Column<string>(type: "VARCHAR(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    api_secret = table.Column<string>(type: "VARCHAR(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                table: "ZoomSettings",
                columns: new[] { "id", "api_key", "api_secret", "created_by", "created_on", "sdk_key", "sdk_secret", "updated_by", "updated_on", "webhook_secret", "webhook_verification_key" },
                values: new object[] { "f41a902f-fabd-4749-ac28-91137f685cb8", "api_key value", "api_secret value", "30fcd978-f256-4733-840f-759181bc5e63", new DateTime(2022, 11, 4, 10, 35, 19, 307, DateTimeKind.Utc).AddTicks(3004), "sdk key value", "sdk secret value", "30fcd978-f256-4733-840f-759181bc5e63", new DateTime(2022, 11, 4, 10, 35, 19, 307, DateTimeKind.Utc).AddTicks(3004), null, null });
