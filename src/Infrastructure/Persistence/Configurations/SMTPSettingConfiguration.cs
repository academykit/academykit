namespace Lingtren.Infrastructure.Persistence.Configurations
{
    ...
    public class SMTPSettingConfiguration : IEntityTypeConfiguration<SMTPSetting>
    {
        public void Configure(EntityTypeBuilder<SMTPSetting> builder)
        {
            ...
            builder.Property(x => x.MailServer).HasColumnName("mail_server").HasColumnType("VARCHAR(200)").HasMaxLength(200).IsRequired();
            builder.Property(x => x.MailPort).HasColumnName("mail_port").IsRequired();
            builder.Property(x => x.SenderName).HasColumnName("sender_name").HasColumnType("VARCHAR(200)").HasMaxLength(200).IsRequired();
            builder.Property(x => x.SenderEmail).HasColumnName("sender_email").HasColumnType("VARCHAR(200)").HasMaxLength(200).IsRequired();
            ...
            builder.Property(x => x.ReplyTo).HasColumnName("reply_to").HasColumnType("VARCHAR(200)").HasMaxLength(200).IsRequired();
