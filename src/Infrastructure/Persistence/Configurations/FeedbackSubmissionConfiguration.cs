namespace Lingtren.Infrastructure.Persistence.Configurations
{
    ...
    public class FeedbackSubmissionConfiguration : IEntityTypeConfiguration<FeedbackSubmission>
    {
        public void Configure(EntityTypeBuilder<FeedbackSubmission> builder)
        {
            ...
            builder.Property(x => x.FeedbackId).HasColumnName("feedback_id").HasColumnType("VARCHAR(50)").HasMaxLength(50).IsRequired();
            ...
            builder.Property(x => x.Answer).HasColumnName("answer").HasColumnType("VARCHAR(5000)").HasMaxLength(5000).IsRequired(false);
