namespace Lingtren.Infrastructure.Persistence.Configurations
{
    ...
    public class LevelConfiguration : IEntityTypeConfiguration<Level>
    {
        public void Configure(EntityTypeBuilder<Level> builder)
        {
            ...
            builder.Property(x => x.Slug).HasColumnName("slug").HasColumnType("VARCHAR(270)").HasMaxLength(250).IsRequired();
            ...
            builder.HasMany(x => x.Courses).WithOne(x => x.Level).HasForeignKey(x => x.LevelId).OnDelete(DeleteBehavior.NoAction);
        }
    }
}