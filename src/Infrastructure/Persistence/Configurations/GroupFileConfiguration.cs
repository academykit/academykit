namespace Lingtren.Infrastructure.Persistence.Configurations
{
    ...
    public class GroupFileConfiguration : IEntityTypeConfiguration<GroupFile>
    {
        public void Configure(EntityTypeBuilder<GroupFile> builder)
        {
            ...
            builder.Property(x => x.Key).HasColumnName("key").HasColumnType("VARCHAR(200)").HasMaxLength(100).IsRequired();
            builder.Property(x => x.MimeType).HasColumnName("mime_type").HasColumnType("VARCHAR(50)").IsRequired();
            builder.Property(x => x.Name).HasColumnName("name").HasColumnType("VARCHAR(200)").HasMaxLength(100).IsRequired();
