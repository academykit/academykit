...
namespace Lingtren.Infrastructure.Persistence.Configurations
{
    public class QuestionSetResultConfiguration : IEntityTypeConfiguration<QuestionSetResult>
    {
        public void Configure(EntityTypeBuilder<QuestionSetResult> builder)
        {
            ...
            builder.Property(x => x.TotalMark).HasColumnName("total_mark").HasColumnType("decimal(20,4)");
            builder.Property(x => x.NegativeMark).HasColumnName("negative_mark").HasColumnType("decimal(20,4)");
