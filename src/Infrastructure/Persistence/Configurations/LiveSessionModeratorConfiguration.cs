namespace Lingtren.Infrastructure.Persistence.Configurations
{
    ...
    public class LiveSessionModeratorConfiguration : IEntityTypeConfiguration<LiveSessionModerator>
    {
        public void Configure(EntityTypeBuilder<LiveSessionModerator> builder)
        {
