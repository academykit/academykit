namespace Lingtren.Infrastructure.Services
{
    ...
    public class HangfireJobService : BaseService, IHangfireJobService
    {
        ...
        /// <returns></returns>
        [AutomaticRetry(Attempts = 5, OnAttemptsExceeded = AttemptsExceededAction.Delete)]
        public async Task SendCertificateIssueMailAsync(Course course, IList<CertificateUserIssuedDto> certificateUserIssuedDtos, PerformContext context = null)
        {
            try
            {
                if (context == null)
                ...
                foreach (var user in certificateUserIssuedDtos)
                {
                    ...
                    var html = $"Dear {fullName},<br><br>";
                    html += $"We are happy to inform you that your Certificate of Achievement for {course.Name} has been issued and is now available in your profile on the application. " 
