...
namespace Lingtren.Api.Controllers
{
    public class UserController : BaseApiController
    {
        ...
        public async Task<UserResponseModel> CreateUser(UserRequestModel model)
        {
            ...
            BackgroundJob.Enqueue<IHangfireJobService>(job => job.SendUserCreatedPasswordEmail(entity.Email, entity.FirstName, password, company,null));
        ...
        public async Task<UserResponseModel> UpdateUser(Guid userId, UserRequestModel model)
        {
            ...
            if (password != null)
            {
                ...
                BackgroundJob.Enqueue<IHangfireJobService>(job => job.SendUserCreatedPasswordEmail(existing.Email, existing.FullName, password, company, null));
            }
